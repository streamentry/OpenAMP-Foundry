...
| R5 | Add preprint evidence bundle schema (PEB-) — read-only snapshot of all evidence for a run. | External reviewers can verify every claim from a single self-contained artifact; closes Phase R. | C |
