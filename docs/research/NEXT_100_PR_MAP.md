...
| S5 | Add prediction quality trend report schema (PQT-). | Tracks cumulative prediction quality across all confirmed WHR results; rolling precision/accuracy trend; degradation alerts; closes Phase S. | C |
