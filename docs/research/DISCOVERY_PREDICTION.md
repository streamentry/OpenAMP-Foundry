...
1 CLOSE_RELATIVE (SEED-005 at 60%). Full breakdown: [`docs/evidence/NOVELTY_BROAD_CHECK.md`](../evidence/NOVELTY_BROAD_CHECK.md).
...
Tam 2002), 1 CLOSE_RELATIVE (SEED-005_VAR_009 at 60% sim). Full report: [`docs/evidence/NOVELTY_BROAD_CHECK.md`](../evidence/NOVELTY_BROAD_CHECK.md).
