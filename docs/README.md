...
3. [Current Metrics](METRICS_CURRENT.md) records current measured performance
...
- Metrics: [`METRICS_CURRENT.md`](METRICS_CURRENT.md).
- Current work: [`ROADMAP.md`](ROADMAP.md) and
  [`NEXT_100_PR_MAP.md`](NEXT_100_PR_MAP.md).
