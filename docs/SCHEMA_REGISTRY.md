...
| Candidate manifest | Lists panel candidates, roles, hashes, release status, and proof level. | High. | [`WET_LAB_HANDOFF.md`](WET_LAB_HANDOFF.md) |
...
| External review packet | Bundles candidate, benchmark, safety, or adoption evidence for external review. | Medium-high. | [`EXTERNAL_REVIEW_PACKET.md`](EXTERNAL_REVIEW_PACKET.md) |
...
| Decision record | Records important project decisions. | Medium-high. | [`DECISION_RECORD_TEMPLATE.md`](DECISION_RECORD_TEMPLATE.md) |
