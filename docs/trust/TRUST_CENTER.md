...
| Claims | Does wording exceed evidence? | `docs/evidence/PROOF_LADDER.md` |
...
| Data | Can the data be used and redistributed? | `DATA_LICENSE_NOTICE.md`, `docs/trust/DATA_GOVERNANCE.md` |
| Models | Should this model/artifact be released? | `MODEL_RELEASE_POLICY.md`, `docs/trust/MODEL_CARD_TEMPLATE.md` |
| Calibration | Can the system update without cherry-picking? | `docs/evidence/CALIBRATION_POLICY.md` |
| Agents | Can agents work safely? | `AGENTS.md`, `docs/getting-started/AGENT_ONBOARDING.md` |
| Maintainers | Can the project survive growth? | `docs/getting-started/MAINTAINER_GUIDE.md`, `docs/trust/RELEASE_CHECKLIST.md` |
